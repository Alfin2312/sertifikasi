...
class Menu extends CI_Controller
{
  ...
  public function index()
  {
    ...
    if ($search) {
      $data = array(
        'pageTitle' => 'Arsip',
        'dataSurat' => $this->arsip->search($search),
        'searchVal' => $search
      );
    } else {
      $data = array(
        'pageTitle' => 'Arsip',
        'dataSurat' => $this->arsip->get(),
        'searchVal' => ''
      );
    }
  ...
  public function create()
  {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $upload = $this->arsip->upload($filename);
      if ($upload['result'] == 'success') {
        $this->arsip->store($upload);
        redirect('menu');
      } else {
        echo $upload['error'];
      }
